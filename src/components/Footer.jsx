...
const navItems = ["Beranda", "Profil Pesantren", "Program Pendidikan", "Kegiatan Harian", "Pendaftaran"];
  ...
  return (
    <footer className="bg-primary-950 text-white pt-16 pb-8 border-t border-primary-900/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-5 lg:pr-8">
            ...
            <div className="flex items-center gap-2 mt-7">
              {[
                ...
                <><rect key="ig-r" x="2" y="2" width="20" height="20" rx="5" ry="5" /><path key="ig-p" d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line key="ig-l" x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></>,
                ...
                >
                  <svg className="w-3.5 h-3.5 text-primary-300/60 hover:text-gold-400 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    {icon}
                  </svg>
                </a>
              ))}
              ...
              {[
                ...
                <div key={c.title} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-primary-300/60 mb-1.5">{c.address}</p>
                    <a
                      href={`tel:${c.tel}`}
        ...
        <div className="border-t border-white/5 mt-12 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-primary-300/40 text-xs font-medium text-center sm:text-left">
            © {new Date().getFullYear()} Ma'had Asy-Syakiroh Buntet Pesantren. All rights reserved.
          </p>
          <p className="text-primary-300/40 text-xs font-medium text-center sm:text-right">
