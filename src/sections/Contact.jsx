      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
          {contacts.map((c, idx) => {
            ...
            return (
              <FadeInSection key={c.type} delay={0.2 + idx * 0.1}>
                <div
                  className="bg-white rounded-[2rem] p-8 lg:p-8 border border-slate-200/70 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:border-primary-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col relative group/card h-full"
                >
                  <div className="mb-8">
                    <span
